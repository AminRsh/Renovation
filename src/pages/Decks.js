            ...
            <div className="container mx-auto px-16 sm:max-md:px-16 sm:max-md:min-w-full">
                ...
                <div className="mx-auto text-lg max-w-[500px]">
                    <p className='text-center text-slate-600'>
                        <span>
                            Design and installation of decks and fences. 
                            We can install various styles from pressure treated lumber, 
                            cedar and or vinyl. MTM offers various designs of custom 
                            build decks to modern fence and gates.
                        </span>
                    </p>
                </div>
